...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, clip_images, dino_images=None):
        if dino_images is not None:
            image_features = self.get_model().get_vision_tower()(clip_images, dino_images)
        else:
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        images, dino_images, image_sizes=None
    ):
        ...
        if type(images) is list or images.ndim == 5:
            ...
            if dino_images is not None:
                assert isinstance(vision_tower.image_processor, tuple)
                ...
                assert not isinstance(vision_tower.image_processor, tuple)
            ...
            if dino_images is not None:
                image_features = self.encode_images(images, dino_images)
            else:
